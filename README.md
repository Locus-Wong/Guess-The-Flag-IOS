# Guess The Flag
This is a mobile game app that lets players guess the country name from the flag. Each game has 8 guesses. After the game ends, the total score will be given, and the player will be asked to restart the game.
</br>
